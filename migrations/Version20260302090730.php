 ...
 */
final class Version20260302090730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE videos (id BINARY(16) NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(20) NOT NULL, original_path VARCHAR(512) DEFAULT NULL, hls_path VARCHAR(512) DEFAULT NULL, preview_image_path VARCHAR(512) DEFAULT NULL, duration_sec INT DEFAULT NULL, codec VARCHAR(50) DEFAULT NULL, is_active TINYINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
